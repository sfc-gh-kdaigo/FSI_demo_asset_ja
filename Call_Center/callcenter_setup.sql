...
instructions:
  ...
  sample_questions:
    ...
    - question: "昨年1年間の問い合わせ件数とエスカレーション発生件数、およびエスカレーション率を抽出して可視化して"
      answer: "問い合わせデータから昨年（2025年）の問い合わせ件数、エスカレーション件数、発生率を集計しグラフで可視化します。"
    - question: "社内で定義されている上長へのエスカレーション基準を解説して"
      answer: "業務マニュアルからエスカレーション判断基準と手順をご案内します。"
